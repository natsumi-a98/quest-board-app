...
1. `README.md`
2. `AGENTS.md`
3. `docs/architecture.md` が存在する場合は確認する
4. `docs/ai-execution.md` が存在する場合は確認する
5. `prompt/agent.md` が存在する場合は確認する
6. `CLAUDE.md`
7. `prompt/create_issue.md`
8. `prompt/modify_issue.md`

各ファイルの役割は次のとおりです。

- `README.md`: リポジトリ全体の概要、セットアップ、主要コマンドの入口
- `AGENTS.md`: 作業ルール、Issue / PR 運用、検証方針の source of truth
- `docs/architecture.md`: レイヤー責務と変更起点の補助ガイド
- `docs/ai-execution.md`: 調査、実装、検証、報告の進め方をまとめた補助ガイド
- `prompt/agent.md`: 実装開始時に source-of-truth docs を参照させる最小テンプレート
